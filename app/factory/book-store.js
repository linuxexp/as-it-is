...
angular.module('angular-common')
    .service('bookStore', function () {
        ...
        // https://www.json-generator.com/ defination
        /*
                ...
                "verses": [
                    '{{repeat(2)}}',
                    {
                        ...
                        "content": {
                            ...
                            "sans": "Sans content for V{{index()}}"
                        },
                        "synonyms": {
                            "key": "value{{index()}}"
                        },
                        "purport": "Purport for V{{index()}} {{lorem(4)}}"
                    }
                ],
                "purport": "Purport for Chapter {{index()}} {{lorem(2)}}",
        ...
        const book = [{
            "entity": "chapter",
            "index": 0,
            "purport": "As the opposing armies stand poised for battle, Arjuna, the mighty warrior, sees his intimate relatives, teachers and friends in both armies ready to fight and sacrifice their lives.",
            "title": "Observing the Armies on the Battlefield of Kuruksetra",
            "verses": [{
                "entity": "verse",
                "index": 0,
                "content": {
                    "en": "Dhrtarastra said: O Sanjaya, after assembling in the place of pilgrimage at Kuruksetra, what did my sons and the sons of Pandu do, being desirous to fight?",
                    "sans": [
                        "@dhrtarastra @uvaca",
